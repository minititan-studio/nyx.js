const desktop = {
    ...
    desktopFeature(feature) {
        ...
        if (desktop.isNw) {
            ...
            /* If running in the Nyx debugger */
            if (window.iAmInCtIdeDebugger) {
                // eslint-disable-next-line no-console
                console.warn('[' + feature.name + '] - The game is running inside the Nyx debugger, desktop features will only work in desktop exports! :c');
            /* If running in NW.js, not in the Nyx debugger */
        ...
        /* Define Functionality for Electron */
            ...
            const val = ipcRenderer.sendSync('nyx.desktop', feature);
