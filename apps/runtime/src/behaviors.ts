import {ExportedBehavior, ExportedBehaviorDynamic} from '@nyx/shared';
...
const behaviorsLib = {
     ...
     * @param behavior The name of the behavior to be added, as it was named in Nyx Studio.
     ...
     * @param behavior The name of the behavior to be removed, as it was named in Nyx Studio.
     * @catnipAsset behavior:behavior
     */
